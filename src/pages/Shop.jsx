...
const Shop = () => {
  ...
  const shopItems = [
    {
      id: 'lollipop',
      name: 'Math Lollipop',
      description: 'A sweet treat for your virtual desk!',
      icon: '🍭',
      price: 20,
    ...
    {
      id: 'teddy',
      name: 'Number Teddy Bear',
      description: 'A cuddly bear who loves counting!',
      icon: '🧸',
      price: 50,
    ...
    },
    {
      ...
      description: 'Look like a true math pirate captain!',
      icon: '🏴‍☠️',
      price: 75,
    ...
    },
    {
      ...
      description: 'A prehistoric math buddy for your collection!',
      icon: '🦖',
      price: 100,
    ...
    },
    {
      id: 'robot',
      name: 'Math Robot',
      description: 'A helpful robot to assist with calculations!',
      icon: '🤖',
      price: 150,
    ...
    },
    {
      id: 'wizard_hat',
      name: 'Wizard Hat',
      description: 'Perform magical math spells!',
      icon: '🧙‍♂️',
      price: 200,
    ...
    },
    {
      id: 'rocket',
      name: 'Space Rocket',
      description: 'Blast off into the math universe!',
      icon: '🚀',
      price: 250,
    ...
    {
      id: 'crown',
      name: 'Math Champion Crown',
      description: 'Show everyone you\'re a math royalty!',
      icon: '👑',
      price: 500,
  ...
  const confirmPurchase = () => {
    // Process purchase
    const success = purchaseItem({ id: selectedItem.id, price: selectedItem.price });
    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="flex border-b">
          <motion.button
            className={`flex-1 py-4 font-bold text-lg ${activeTab === 'shop' ? 'text-pink-600 border-b-4 border-pink-500' : 'text-gray-500'}`}
          ...
          <motion.button
            className={`flex-1 py-4 font-bold text-lg ${activeTab === 'inventory' ? 'text-blue-600 border-b-4 border-blue-500' : 'text-gray-500'}`}
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
